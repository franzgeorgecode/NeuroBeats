  ...
  const featuredTracks = [
    {
      ...
      duration: 245,
      cover_url: 'https://images.pexels.com/photos/1190298/pexels-photo-1190298.jpeg',
    },
    {
      id: '2', 
      title: 'Cyber Flow',
      ...
      <div className="container mx-auto px-6">
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-xl text-white/80 mb-6">
                  Discover your next favorite track in our curated collection
                </p>
        ...
        >
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {[
              { label: 'Create Playlist', color: 'from-neon-purple to-neon-blue' },
              { label: 'Discover Weekly', color: 'from-neon-blue to-neon-cyan' },
              { label: 'Top Charts', color: 'from-neon-cyan to-neon-green' },
              { label: 'Recently Played', color: 'from-neon-green to-neon-pink' },
            ].map((action, index) => (
              <motion.div
                key={action.label}
